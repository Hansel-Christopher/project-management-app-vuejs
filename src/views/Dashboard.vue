<template>
  <div class="container-fluid">
    <div class="row">
      <div class="col">
        <h4 class="my-3">Active Projects</h4>
      </div>
    </div>
    <div class="row equal">
      <div class="col-xs-12 col-sm-6 col-md-3 d-flex pb-3" v-for="board in unarchivedBoards" :key="board.id">
        <div class="card w-100 board-item">
          ...
          <div class="card-footer bg-transparent">
            ...
            >
            <button  class="btn btn-sm mb-1" @click="handleTaskBoardEditing(board)">Edit Project</button>
    ...
    <div style="display: none;" class="row" v-show="this.archivedBoards.length > 0">
      <div style="display: none;" class="col">
        <h4 class="my-3">Archived Boards</h4>
      </div>
    </div>
    <div style="display: none;" class="row equal" v-show="this.archivedBoards.length > 0">
      <div style="display: none;" class="col-xs-12 col-sm-6 col-md-3 d-flex pb-3" v-for="board in archivedBoards" :key="board.id">
        <div style="display: none;" class="card w-100 board-item">
          <div class="card-body">
            <h5 class="card-title flex-nowrap">{{ board.name }}</h5>
            <p class="card-text">{{ board.description }}</p>
          </div>
